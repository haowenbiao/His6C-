...
using MedicineStoreHouseInformation.DataList;

namespace MedicineStoreHouseInformation
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(new FormMedicineStoreHouseInformations(tmpLoginInformation));
        }
    }
}
